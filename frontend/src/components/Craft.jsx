...
const Craft = () => {
    ...
    useEffect(()=>{
        const craft = products.filter((item)=>(item.craft));
        console.log('Craft filtered:', craft);
        setCraftProducts(craft.slice(0,10));
    },[products])
  ...
  return (
    <div className='relative my-10'>
        ...
        <div className='relative text-center text-3xl py-8'>
            ...
            <img src={assets.decor4} className='absolute -bottom-8 -left-12 w-24 h-24 opacity-100 hidden md:block' alt="Decor" />
